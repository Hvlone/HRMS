...
public interface HouseMapper {
     ...
     * @return 影响行数
     */
    @Insert("INSERT INTO house(landlord_id, title, address, price, area, description, status, create_time) " +
            "VALUES(#{landlordId}, #{title}, #{address}, #{price}, #{area}, #{description}, #{status}, #{createTime})")
